...
const EngineDashboard = () => {
  ...
  const charts=[
    ...
    // {title:"Engine Temperature",  id:[2,3]},
    // {title:"Cooling",             id:[5,6,7]},
    {title:"Engine Temperature",  id:[3]},
    // {title:"Battery Temperature", id:[2]},
    // {title:"Battery Voltage",     id:[0]},
    // {title:"Battery Current",     id:[1]},
  ]
  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="ENGINE" subtitle="Welcome to the Engine Dashboard" />
